...
np.savetxt("Uniform_Data_0.75_Unit.txt", generateRawData(500, 150, 0.75, "uniform"))

np.savetxt("Gaussian_Data_0.75_Unit.txt", generateRawData(500, 150, 0.75, "gaussian"))

np.savetxt("Uniform_Data_0.90_Unit.txt", generateRawData(500, 150, 0.90, "uniform"))

np.savetxt("Gaussian_Data_0.90_Unit.txt", generateRawData(500, 150, 0.90, "gaussian"))

np.savetxt("Uniform_Data_1.1_Unit.txt", generateRawData(500, 150, 1.1, "uniform"))

np.savetxt("Gaussian_Data_1.1_Unit.txt", generateRawData(500, 150, 1.25, "gaussian"))

np.savetxt("Uniform_Data_1.25_Unit.txt", generateRawData(500, 150, 1.25, "uniform"))

np.savetxt("Gaussian_Data_1.25_Unit.txt", generateRawData(500, 150, 1.1, "gaussian"))

np.savetxt("Uniform_Data_0.15_Unit.txt", generateRawData(500, 150, 0.75, "uniform"))

np.savetxt("Gaussian_Data_0.15_Unit.txt", generateRawData(500, 150, 0.75, "gaussian"))

np.savetxt("Uniform_Data_0.25_Unit.txt", generateRawData(500, 150, 0.25, "uniform"))

np.savetxt("Gaussian_Data_0.25_Unit.txt", generateRawData(500, 150, 0.25, "gaussian"))
